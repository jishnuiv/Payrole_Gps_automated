  ...
  void showalertdialogue() {
    ...
    addStdData({replay,chat_id})async {
      ...
      http.Response result = await http
          .post(Uri.parse("http://192.168.43.44/automated_payrole/reply.php"), body: parameters);
      print(parameters);
        ...
        showDialog(
            ...
            builder: (Context) =>
                AlertDialog(
                  ...
                  title: Center(child: Text("Replay")),
                  content: SingleChildScrollView(
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [TextField(
                      controller: idcontroller,
                      decoration: InputDecoration(hintText: "messege id"),
                    ),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [SizedBox(height: 10),
                            RaisedButton(
                              onPressed: () {
                                addStdData(chat_id: idcontroller.text,
