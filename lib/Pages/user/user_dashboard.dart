                  ...
                  child:   Container(
                    ...
                    child:  Column(
                      children: [
                        ...
                        Center(child: Text('Notifications', style: TextStyle(fontSize: 15,color: Colors.black))),
                      ],
                    ),
                    color: Colors.white,
                  ),
                  ...
                  child:   Container(
                    ...
                    child:  Column(
                      children: [
                        ...
                        Center(child: Text('chat/view', style: TextStyle(fontSize: 15,color: Colors.black))),
                      ],
                    ),
                    color: Colors.white,
                  ),
