...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginData({Username, Password}) async {
    ...
    http.Response result = await http
        .post(Uri.parse(baseurl+"login.php"), body: parameters);
    print(parameters);
    ...
    if (result.statusCode == 200) {
      ...
      if (status == "success") {
        ...
        if(jsonObject['rol']=="user")
          ...
          Navigator.of(context).pushNamed('hr_dash');
      }
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    loginData( Username:usernamecontroller.text,Password: passwordcontroller.text ,);
